...
namespace Pasteleria.Business.Repositories
{
    public class IngredientRepository : IIngredientRepository
    {
        ...
        public async Task DeleteAsync(Guid id)
        {
            ...
            _context.Ingredients.Remove(result.Result);
            await _context.SaveChangesAsync();
        }
        ...
        {
            var result = await _context.Ingredients.AsNoTracking().Include(ri=> ri.RecipeIngredients).Include(i => i.InventoryItems).FirstOrDefaultAsync(r => r.Id == id);
